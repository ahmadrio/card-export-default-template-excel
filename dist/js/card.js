...
Nova.booting(function (Vue, router) {
    Vue.component('card-export-default-template-excel', __webpack_require__(2));
});
    ...
    methods: {
        processExport: function processExport() {
            ...
            axios.post('/nova-vendor/card-export-default-template-excel/endpoint/' + this.card.resource, formData, {
                ...
                link.href = url;
                link.setAttribute('download', _this.card.resource + '.xlsx');
                document.body.appendChild(link);
                link.click();
                _this.$toasted.success('Success Export.');
            });
        }
    },
...
var render = function() {
  ...
  return _c("card", { staticClass: "card flex flex-col card-panel" }, [
    _c("div", { staticClass: "px-3 py-3" }, [
      _c("h1", { staticClass: "text-lg font-bold" }, [
        _vm._v("Export Default Template")
      ]),
      _vm._v(" "),
      _c(
        "form",
        ...
        [
          _c("div", { staticClass: "py-4" }, [
            _c("ul", { staticClass: "list-reset" }, [
              _c("li", [
                _vm._v("Resource Name: " + _vm._s(this.card.resourceLabel))
              ]),
              _vm._v(" "),
              _c("li", [
                _vm._v("File Name: " + _vm._s(this.card.resource) + ".xls")
              ])
            ])
          ]),
          _vm._v(" "),
